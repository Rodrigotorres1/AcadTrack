...
| Coordenador | Gerenciar simulados | Criar simulado com composicao valida, bloquear disciplina inexistente/repetida, validar descricao duplicada | Versao de simulado, janela de aplicacao, auditoria da composicao |
...
| Aluno | Acompanhar desempenho | Visualizar resultado consolidado e risco academico (via fluxos existentes) | Metas de recuperacao, graficos de evolucao, historico pessoal |
| Responsavel | Consultar informacoes do aluno | Consultar notas, simulados e desempenho com vinculo/permissoes validos | Permissoes granulares por recurso, alertas proativos, resumo de acompanhamento |

## Backlog sugerido por prioridade

1. Implementar controle de acesso por perfil (incluindo Coordenador como role tecnica).
2. Auditoria da composicao dos simulados.
